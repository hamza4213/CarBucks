...
import { getCategories, getPromotions, getSubCategoryById } from '../../redux/actions';
...
export default function Home() {
  ...
  console.log(activeTab?.type, subCategories[0])
...

              {
                categories.map((item,) => (
                  <TouchableOpacity
                    ...
                    <Text
                      style={activeTab === item ? styles.ActiveTabText : styles.tabText}>
                      {item.title}
                    </Text>
                  </TouchableOpacity>
